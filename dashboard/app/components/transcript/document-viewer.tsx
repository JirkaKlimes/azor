...
export default function DocumentViewer({
    ...
    if (highlightStart !== undefined && highlightEnd !== undefined) {
        ...
        return (
            <div className="max-h-100 prose prose-sm overflow-y-auto p-4 dark:prose-invert prose-headings:my-3 prose-p:my-2">
                <ReactMarkdown remarkPlugins={[remarkGfm]}>{before}</ReactMarkdown>
                <span
                    ref={highlightRef}
                    className="dark:bg-yellow-900/50! rounded px-0.5"
