...
function AvatarImage({
    ...
    return (
        <AvatarPrimitive.Image
            ...
            className={cn('size-full aspect-square rounded-full object-cover', className)}
            {...props}
        />
    )
}
...
function AvatarFallback({
    ...
    return (
        <AvatarPrimitive.Fallback
            ...
            className={cn(
                'size-full bg-muted text-muted-foreground flex items-center justify-center rounded-full text-sm group-data-[size=sm]/avatar:text-xs',
                className,
            )}
            {...props}
        />
